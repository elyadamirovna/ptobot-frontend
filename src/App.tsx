...
export default function TelegramWebAppGlassPure() {
  ...
  return (
    <div className="relative flex min-h-[100dvh] w-full flex-col overflow-hidden bg-[#05122D] text-white">
      ...
      <main className="relative z-10 flex min-h-[100dvh] w-full flex-1 justify-center overflow-y-auto overscroll-contain bg-[#05122D] px-3 py-6 touch-pan-y md:px-4 md:py-10">
