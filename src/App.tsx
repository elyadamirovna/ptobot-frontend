    ...
    <div className="space-y-5">
      ...
      <Card className="glass-card">
        ...
        <CardContent className="space-y-4">
          ...
          <Button className="w-full bg-sky-500 hover:bg-sky-600" onClick={handleStep1Next}>
            Далее
          </Button>
        </CardContent>
      </Card>
  ...
  const SuccessScreen = () => (
    <div className="flex h-full flex-col items-center justify-center gap-4 text-center text-white">
      ...
      <div className="flex w-full max-w-md gap-3">
        ...
        <Button className="flex-1 bg-sky-500 hover:bg-sky-600" onClick={() => setScreen("dashboard")}>
          На главную
        </Button>
      </div>
    </div>
