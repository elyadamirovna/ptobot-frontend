...
export default function TelegramWebAppGlassPure() {
  ...
  return PreviewComponent ? (
    ...
    >
      <div className="pointer-events-none absolute -left-24 -top-32 h-72 w-72 rounded-full bg-indigo-500/35 blur-[140px]" />
      ...
      >
        <div className="mx-auto w-full max-w-full md:max-w-[620px] lg:max-w-[700px]">
          <div className="relative rounded-[22px] px-4 pb-7 pt-5 sm:rounded-[26px] sm:px-6 sm:pb-8 sm:pt-6 lg:rounded-[30px] lg:px-8 lg:pb-9 lg:pt-7">
            ...
            <div className="relative" ref={swipeAreaRef}>
              ...
              <div className="mb-5 grid gap-3 sm:grid-cols-3">
                ...
                <div className="glass-chip border border-white/25 bg-white/10 px-3.5 py-3 text-white shadow-[0_16px_40px_rgba(6,17,44,0.45)] sm:px-4">
                  ...
                  <p className="mt-2 text-[11px] text-white/70">Отчёт доступен для просмотра.</p>
                </div>
                ...
                <TabsContent value="report" className="mt-0">
                  <Card className="glass-panel border-white/25 bg-gradient-to-br from-white/14 via-white/10 to-white/5 text-white shadow-[0_28px_80px_rgba(6,17,44,0.55)] backdrop-blur-[32px]">
                    ...
                    <CardContent className="space-y-6 text-[12px] sm:p-7 sm:pt-1 sm:text-[13px]">
                      <div className="grid gap-3 rounded-2xl border border-white/18 bg-white/6 p-4 backdrop-blur-xl">
                        <div className="space-y-1.5">
                          ...
                          <div className="relative">
                            ...
                            <Select value={project} onValueChange={setProject}>
                              <SelectTrigger className="h-11 rounded-xl border border-white/18 bg-white/10 pl-11 pr-12 text-[13px] font-medium text-white/90 shadow-[0_12px_28px_rgba(7,24,74,0.45)] backdrop-blur transition hover:border-white/35 sm:h-12 sm:text-[14px]">
                        ...
                        <div className="space-y-1.5">
                          ...
                          <div className="relative">
                            <Input
                              ...
                              className="h-11 rounded-xl border border-white/18 bg-white/10 pl-12 pr-12 text-[13px] font-medium text-white/90 placeholder:text-white/50 transition focus:border-white/45 [appearance:none] sm:h-12 sm:text-[14px]"
                            />
                        ...
                        <div className="space-y-1.5">
                          ...
                          <div className="flex items-center gap-2">
                            <Input
                              ...
                              className="h-11 flex-1 rounded-xl border border-white/18 bg-white/10 text-[13px] font-medium text-white/90 placeholder:text-white/40 transition focus:border-white/45 sm:h-12 sm:text-[14px]"
                            />
                            <div className="flex h-11 items-center justify-center rounded-xl border border-white/15 bg-white/10 px-3 text-[11px] text-white/75 shadow-[0_8px_20px_rgba(7,24,74,0.35)] sm:h-12 sm:px-4 sm:text-[12px]">
                              м³
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="relative">
                          ...
                          <Input
                            ...
                            className="h-11 rounded-xl border border-white/18 bg-white/10 pl-11 text-[13px] font-medium text-white/90 placeholder:text-white/40 transition focus:border-white/45 sm:h-12 sm:text-[14px]"
                          />
                        </div>
                      </div>
                      ...
                      <div className="space-y-1.5">
                        ...
                        <Textarea
                          ...
                          className="min-h-[80px] rounded-2xl border border-white/18 bg-white/10 text-[12px] text-white/90 placeholder:text-white/45 sm:min-h-[96px] sm:text-[13px]"
                        />
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex flex-col gap-3 rounded-2xl border border-white/15 bg-white/6 px-4 py-3 text-sm text-white/75">
                          <div className="flex items-center gap-3">
                            <Button
                              type="button"
                              className="flex h-11 w-11 items-center justify-center rounded-xl border border-white/20 bg-white/80 text-sky-900 shadow-[0_10px_26px_rgba(3,144,255,0.35)] transition hover:-translate-y-0.5 hover:shadow-[0_16px_32px_rgba(3,144,255,0.35)] active:translate-y-0"
                              onClick={onPickFiles}
                            >
                              <Upload className="h-5 w-5" />
                            </Button>
                            <div className="flex-1 text-[12px] leading-snug text-white/80">
                              Добавьте фото — так проще сверить объём работ.
                            </div>
                            {Boolean(files.length) && (
                              <Button
                                ...
                                variant="secondary"
                                size="sm"
                                className="h-9 rounded-lg border-white/30 bg-white/15 px-3 text-[11px] text-white/80 backdrop-blur transition hover:bg-white/25"
                                onClick={() => {
                                  setFiles([]);
                                  setPreviews([]);
                          ...
                          {fileValidationMessage && (
                            <div className="text-[11px] text-amber-100/90 sm:text-[12px]">
                              {fileValidationMessage}
                            </div>
                          )}
                        </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
                          <Button
                            type="button"
                            className="h-12 min-w-[190px] rounded-xl bg-white px-7 text-[13px] font-semibold text-sky-900 shadow-[0_18px_40px_rgba(255,255,255,0.35)] transition hover:-translate-y-0.5 hover:shadow-[0_24px_52px_rgba(255,255,255,0.32)] active:translate-y-0 disabled:opacity-70"
                            onClick={sendReport}
                          ...
                          <div className="flex-1">
                            <div className="h-1.5 w-full overflow-hidden rounded-full bg-white/12">
                              <div
                                className="h-full rounded-full bg-sky-300/90 transition-all"
