...
export default function TelegramWebAppGlassPure() {
  ...
  return (
    <div className="relative flex min-h-[100dvh] w-full flex-col bg-[#05122D] text-white">
      {/* фиксированный фон под весь webview, в т.ч. при оверскролле */}
      <div className="pointer-events-none fixed inset-0 -z-10 bg-[#05122D]" />
      <div className="pointer-events-none fixed -left-24 -top-32 -z-10 h-72 w-72 rounded-full bg-sky-500/40 blur-[140px]" />
      <div className="pointer-events-none fixed bottom-0 right-[-120px] -z-10 h-[420px] w-[420px] rounded-full bg-indigo-600/40 blur-[160px]" />
      <div className="pointer-events-none fixed inset-x-1/2 top-[40%] -z-10 h-64 w-64 -translate-x-1/2 rounded-full bg-cyan-400/30 blur-[120px]" />

      {/* основной контент; скролл теперь по всей странице, а не только по main */}
      <main
        className="relative z-10 flex w-full flex-1 justify-center px-3 py-6 touch-pan-y md:px-4 md:py-10 pb-[env(safe-area-inset-bottom)]"
