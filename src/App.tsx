        ...
        <div className="relative overflow-hidden rounded-[32px] border border-white/25 bg-white/10 px-4 pb-8 pt-6 shadow-[0_35px_100px_rgba(6,24,74,0.62)] backdrop-blur-[36px] sm:rounded-[44px] sm:px-6 sm:pb-9 sm:pt-7 lg:rounded-[52px] lg:px-8 lg:pb-10 lg:pt-8">
          ...
          <div className="relative">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <div className="sticky top-4 z-20 -mx-2 -mt-2 rounded-[28px] border border-white/15 bg-[#030a1f]/90 px-3 pb-3 pt-4 backdrop-blur supports-[backdrop-filter]:bg-[#030a1f]/80 sm:-mx-3 sm:-mt-3 sm:rounded-[32px] sm:px-4 sm:pb-4 sm:pt-5 lg:-mx-4 lg:-mt-4 lg:rounded-[36px] lg:px-5">
