...
export const MinimalistLayout: FC = () => (
  <div className="flex min-h-[100dvh] flex-col gap-6 bg-slate-950 px-4 py-6 text-slate-50 overflow-x-hidden overflow-y-auto overscroll-contain">
...
export const GlassmorphismLayout: FC = () => (
  <div className="relative flex min-h-[100dvh] justify-center overflow-x-hidden overflow-y-auto overscroll-contain bg-gradient-to-br from-[#161323] via-[#1b1a2e] to-[#0f0d1d] px-6 py-8 text-slate-100">
...
export const CorporateStrictLayout: FC = () => (
  <div className="flex min-h-[100dvh] flex-col bg-slate-100 text-slate-900 overflow-y-auto overflow-x-hidden overscroll-contain">
