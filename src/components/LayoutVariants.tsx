...
export const MinimalistLayout: FC = () => (
  <div className="flex min-h-screen flex-col gap-6 bg-slate-950 px-4 py-6 text-slate-50">
...
export const GlassmorphismLayout: FC = () => (
  <div className="relative flex min-h-screen justify-center overflow-hidden bg-gradient-to-br from-[#161323] via-[#1b1a2e] to-[#0f0d1d] px-6 py-8 text-slate-100">
    ...
    <div className="relative grid w-full max-w-5xl gap-6 md:grid-cols-[88px_1fr]">
      <aside className="hidden flex-col justify-between rounded-[2.25rem] border border-white/10 bg-white/5/50 p-4 backdrop-blur-2xl md:flex">
      ...
      <div className="flex flex-col gap-6 md:grid md:grid-cols-[1.15fr_0.85fr] md:gap-8">
            ...
            <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
              <div className="space-y-3">
                ...
                <p className="max-w-xs text-sm text-white/70">
                  Выберите проект, укажите объём выполненных работ и прикрепите подтверждающие материалы. Система напомнит о пропущенных пунктах.
                </p>
              </div>
              <div className="flex flex-col gap-3 text-sm">
                {[
                  {
                    title: "Шаг 1",
                    description: "Объект, дата и вид работ",
                  },
                  {
                    title: "Шаг 2",
                    description: "Описание задач и ресурсы",
                  },
                  {
                    title: "Шаг 3",
        ...
        <div className="flex flex-col gap-6">
              ...
              {["Новый доступ выдан", "Отчёт принят", "Новый комментарий"].map((note, index) => (
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-white/40">{index === 0 ? "5 мин назад" : index === 1 ? "1 час назад" : "2 часа назад"}</p>
                  </div>
          ...
          <div className="rounded-[2.5rem] border border-white/10 bg-gradient-to-br from-white/15 via-white/5 to-transparent p-6 text-center backdrop-blur-2xl md:p-8">
            ...
            <p className="mt-3 text-sm text-white/70">
              Подключите WebApp и получайте отчёты в реальном времени с визуализацией прогресса, уведомлениями и умными напоминаниями.
            </p>
